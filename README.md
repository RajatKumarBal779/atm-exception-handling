# 🏦 ATM Exception Handling System
📖 About the Project

This is a Python-based ATM simulation program that demonstrates how to handle errors and exceptions effectively.
The project focuses on both pre-defined exceptions (like ValueError) and programmer-defined exceptions such as:
WithdrawError
DepositError
...
LinkedIn: linkedin.com/in/rajat-kumar-bal
